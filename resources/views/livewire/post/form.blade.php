    ...
    <div>
        @foreach($form->loaded_datetime as $i => $loadTime)
            <span id="badge-dismiss-default" class="inline-flex items-center px-2 py-1 me-2 mb-3 text-sm font-medium text-blue-800 bg-blue-100 rounded dark:bg-blue-900 dark:text-blue-300">
                ...
                <button type="button" wire:loading.class="disabled opacity-50" wire:loading.attr="disabled" wire:click="onRemoveLoadTimePressed({{$i}})" class="inline-flex items-center p-1 ms-2 text-sm text-blue-400 bg-transparent rounded-sm hover:bg-blue-200 hover:text-blue-900 dark:hover:bg-blue-800 dark:hover:text-blue-300" data-dismiss-target="#badge-dismiss-default" aria-label="Remove">
