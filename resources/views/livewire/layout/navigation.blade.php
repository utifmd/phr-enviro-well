                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can(\App\Policies\UserPolicy::IS_NOT_GUEST_ROLE)
                        <x-nav-link :href="route('well-masters.index')"
                                    :active="request()->routeIs('well-masters.index')" wire:navigate>
                            {{ __('Well Master') }}
                        </x-nav-link>
                    @endcan
                    @can(\App\Policies\UserPolicy::IS_PHR_ROLE)
                        <x-nav-link :href="route('posts.load-request')"
                                    :active="request()->routeIs('posts.load-request')" wire:navigate>
                            <div class="relative">
                                {{ __('Load Request') }}
                            </div>
                        </x-nav-link>
